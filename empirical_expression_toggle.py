...
def hill_function(args, x):
    """
    args: list
        Parameters in a list, [a, b, n, k1, k2, n1, n2]
    """
...
if __name__ == '__main__':
    ...
    # %%
    sim_lac_mRNA = hill_function([10.99e-2, 1.8e0, 1.1e1, .74, .71, 3.9, 1.6], sim_gr)  # 10.99e+04

    sim_tetr_mRNA = hill_function([9.45e-2, 9.48e+00, 3.32e+01, 5.43e-01, 3.3e-01, 2.91e+00, 1.6e0], sim_gr)
